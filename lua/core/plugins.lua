...
local function _3_()
  ...
  return use({branch = "dev", config = "require('plugins.cmp')", event = {"InsertEnter", "CmdlineEnter"}, requires = {{config = "require('plugins.luasnip')", event = "BufReadPre", requires = {{opt = false, "rafamadriz/friendly-snippets"}}, wants = "friendly-snippets", "L3MON4D3/LuaSnip"}, {module = "lspkind", "onsails/lspkind-nvim"}, {"hrsh7th/cmp-nvim-lsp"}, {"hrsh7th/cmp-path"}, {"hrsh7th/cmp-buffer"}, {"hrsh7th/cmp-cmdline"}, {"saadparwaiz1/cmp_luasnip"}, {module = "cmp-under-comparator", "lukas-reineke/cmp-under-comparator"}}, wants = {"LuaSnip"}, "hrsh7th/nvim-cmp"})
end
